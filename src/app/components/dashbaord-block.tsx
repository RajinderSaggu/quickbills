    ...
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 md:gap-8">
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <DollarSign className="size-8 text-red-600 dark:text-red-300" />
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <Users className="size-8 text-purple-600 dark:text-purple-300 " />
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <CreditCard className="size-8 text-green-600  dark:text-green-300" />
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <Activity className="size-8 text-yellow-600 dark:text-yellow-300 " />
        </CardHeader>
        <CardContent>
